                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-sm-6">
                                    <select class="form-select border-0" style="height: 55px;">
                                        ...
                                        <option value="3">Package Delivery</option>
                                        <option value="3">Luggage Delivery</option>
                                ...
                                <div class="col-12 col-sm-6">
                                    <select class="form-select border-0" style="height: 55px;">
                                        ...
                                        <option value="3">Just delivery</option>
                                    </select>
                                </div>
                                <div class="col-12 col-sm-6">
                                ...
                                <div class="col-12">
                                    <button class="btn btn-secondary w-100 py-3" type="submit" name="add_to_cart">Book Now</button>
                                </div>
                            </div>
                        </form>
                    </div>
